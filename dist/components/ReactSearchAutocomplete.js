...
function ReactSearchAutocomplete(_a) {
    var _b = _a.items, items = _b === void 0 ? [] : _b, _c = _a.fuseOptions, fuseOptions = _c === void 0 ? config_1.defaultFuseOptions : _c, _d = _a.inputDebounce, inputDebounce = _d === void 0 ? exports.DEFAULT_INPUT_DEBOUNCE : _d, _e = _a.onSearch, onSearch = _e === void 0 ? function () { } : _e, _f = _a.onHover, onHover = _f === void 0 ? function () { } : _f, _g = _a.onSelect, onSelect = _g === void 0 ? function () { } : _g, _h = _a.onFocus, onFocus = _h === void 0 ? function () { } : _h, _j = _a.onBlur, onBlur = _j === void 0 ? function () { } : _j, _k = _a.onMouseLeave, onMouseLeave = _k === void 0 ? function () { } : _k, _l = _a.onClear, onClear = _l === void 0 ? function () { } : _l, _m = _a.showIcon, showIcon = _m === void 0 ? true : _m, _o = _a.showClear, showClear = _o === void 0 ? true : _o, _p = _a.maxResults, maxResults = _p === void 0 ? exports.MAX_RESULTS : _p, _q = _a.placeholder, placeholder = _q === void 0 ? '' : _q, _r = _a.autoFocus, autoFocus = _r === void 0 ? false : _r, _s = _a.styling, styling = _s === void 0 ? {} : _s, _t = _a.resultStringKeyName, resultStringKeyName = _t === void 0 ? 'name' : _t, _u = _a.inputSearchString, inputSearchString = _u === void 0 ? '' : _u, formatResult = _a.formatResult, _v = _a.showNoResults, showNoResults = _v === void 0 ? true : _v, _w = _a.showNoResultsText, showNoResultsText = _w === void 0 ? 'No results' : _w, _x = _a.showItemsOnFocus, showItemsOnFocus = _x === void 0 ? false : _x, rest = __rest(_a, ["items", "fuseOptions", "inputDebounce", "onSearch", "onHover", "onSelect", "onFocus", "onBlur", "onMouseLeave", "onClear", "showIcon", "showClear", "maxResults", "placeholder", "autoFocus", "styling", "resultStringKeyName", "inputSearchString", "formatResult", "showNoResults", "showNoResultsText", "showItemsOnFocus"]);
    ...
    var _y = (0, react_1.useState)(inputSearchString), searchString = _y[0], setSearchString = _y[1];
    var _z = (0, react_1.useState)([]), results = _z[0], setResults = _z[1];
    var _0 = (0, react_1.useState)(-1), highlightedItem = _0[0], setHighlightedItem = _0[1];
    var _1 = (0, react_1.useState)(false), isSearchComplete = _1[0], setIsSearchComplete = _1[1];
    var _2 = (0, react_1.useState)(false), isTyping = _2[0], setIsTyping = _2[1];
    var _3 = (0, react_1.useState)(false), showNoResultsFlag = _3[0], setShowNoResultsFlag = _3[1];
    var _4 = (0, react_1.useState)(false), hasFocus = _4[0], setHasFocus = _4[1];
